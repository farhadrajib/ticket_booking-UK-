...
$id=$_GET['u_id'];// need to hiden field to data pass to other page

$sql_retrive = "SELECT * FROM user";
...
<table width="600" border="0" align="center" cellpadding="4" cellspacing="0" bordercolor="#F8F8F8">
  <tr>
    <td colspan="9" class="tile">MANAGE USERS</td>
  </tr>
  <tr>
  ...
  <?php
	...
	?>
  <tr>
    <td class="fontstyle"><?php echo $retrive['name'];?></td>
    <td class="fontstyle"><?php echo $retrive['address'];?></td>
    <td class="fontstyle"><?php echo $retrive['e-mail'];?></td>
    <td class="fontstyle"><?php echo $retrive['phone'];?></td>
    <td class="fontstyle"><?php echo $retrive['username'];?></td>
    <td class="fontstyle"><?php echo $retrive['password'];?></td>
    <td class="fontstyle"><?php echo $retrive['status'];?></td>
    <td class="fontstyle"><a href="edit_user.php?u_id=<?php echo $retrive['u_id']; ?>"><span class="header-text">EDIT</span></a></td>
    <td class="fontstyle"><a href="delete_user.php?u_id=<?php echo $retrive['u_id']; ?>">Delete</a></td>
    <?php } ?>
  </tr>
</table>
