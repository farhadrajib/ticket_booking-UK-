...
$sql_retrive = "SELECT * FROM admin ORDER BY id DESC ";
...
<table width="350" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC">
  <tr>
    <td colspan="3" class="tile">MANAGE USER NAME AND PASSWORD</td>
  </tr>
  ...
  <tr>
	...
	?>
  <tr>
    <td class="fontstyle"><?php echo $retrive['u_name'];?></td>
    <td class="fontstyle"><?php echo $retrive['password'];?></td>
     <td class="fontstyle"><a href="edit_password.php?id=<?php echo $retrive['id']; ?>"><img src="images/spanner_48.png" width="15" height="15" /></a></td>
     <?php } ?>
  </tr>
</table>
