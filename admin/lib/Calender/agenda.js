...
function fHoliday(y,m,d) {
	...
	if (m==1&&d==1)
		...
		r=[" Mar 26, "+y+" \n The International Mother Language Day","","#87ceeb","red"];
	else if (m==3&&d==26)
		r=[" Mar 26, "+y+" \n The Independence Day ","","#87ceeb","red"];
	else if (m==12&&d==16)
		r=[" Dec 16, "+y+" \n The Victory Day ","","#87ceeb","red"];
	else if (m==12&&d==25)
		r=[" Dec 25, "+y+" \n Merry X'mas! ","","#87ceeb","red"];	// show a line-through effect
	else if (m==5&&d>20) {
