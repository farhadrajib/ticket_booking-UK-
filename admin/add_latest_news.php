...
if(($_POST['Submit'])=="Submit")
	{
		...
		$sql  = "INSERT INTO latest_news values('','$l_title','$l_details','$status') ";
		$result = $db->query($sql);  
...
<div class="login-white"><!-- InstanceBeginEditable name="editpage" --><form action="" method="post">
<table width="250" border="0" align="center" cellpadding="2" cellspacing="1">
  <tr>
    <td colspan="3"><?php echo $message; ?></td>
  </tr>
  <tr>
    <td class="fontstyle">Title</td>
    <td colspan="2" class="fontstyle"><input type="text" name="l_title" id="l_title" /></td>
  </tr>
  <tr>
    <td class="fontstyle">Details</td>
    <td colspan="2" class="fontstyle"><input type="text" name="l_details" id="l_details" /></td>
  </tr>
  <tr>
    <td class="fontstyle">status</td>
    <td class="fontstyle"><input name="status" type="radio" id="radio" value="1" checked="checked" />
      Published</td>
    <td class="fontstyle"><input type="radio" name="status" id="radio2" value="0" />
      Unpublished</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
